...
Example 2. The question definition showing a picture:
...
Example1. The question definition:

![](/T1T_Image_4.png)

renders to:

Example 2. The question definition showing an MP3 icon to play a recording:
...
- M?ltiple (My apologies for the accent for non Spanish users :-( )
...
4. Show an image associated with each of the options in questions of type ?Unica? and ?M?ltiple?.
